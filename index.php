...
<!-- -========================products part 1========================== -->
    ...
    <div class="container">
        ...
        <div class="catgegories">
            <a href="tomatoes.html"> <div class ="gallery"><img src="/img/tomatoes.jpg" class="item-image"></div>
                <div class="iamge-title"> Tomatoes </div>
        </div>
        </a>
        <div class="catgegories">

            <a href="PepsiPage3.html"> <div class ="gallery"><img src="img/pepsi.jpg" class="item-image"></div>
                <div class="iamge-title">Pepsi </div>
        </div>
        </a>

        <div class="catgegories">
            <a href="seafood-detail.html"><div class ="gallery"><img src="/img/salmon_fillet.jpeg" class="item-image"></div>
                <div class="iamge-title"> Salmon Fillet </div>
        </div>
        </a>
        <div class="catgegories">

            <a href="p3Apples.html"> <div class ="gallery"><img src="img/apples1.jpg" class="item-image"></div>
...
<div class="container">
<div class="catgegories">
    <a href="ChipsPage3.html"><div class ="gallery"> <img src="img/laysstax.jpg" class="item-image"></div>
        <div class="iamge-title"> Lays </div>
</div>
</a>
<div class="catgegories">

    <a href="Dairy&EggsP3_Eggs.html"><div class ="gallery"> <img src="img/eggs.jpg" class="item-image"></div>
        <div class="iamge-title"> Eggs </div>
</div>
</a>

<div class="catgegories">
    <a href="#link"> <div class ="gallery"><img src="img/banana1.jpg" class="item-image"></div>
        <div class="iamge-title"> Bananas </div>
</div>
</a>
<div class="catgegories">

    <a href="#link">  <div class ="gallery"><img src="img/apples1.jpg" class="item-image"></div>
    <div class="iamge-title"> Apples </div>
</div>
</a>
<hr></div>
